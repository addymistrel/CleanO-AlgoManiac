...
mapboxgl.accessToken =
  "pk.eyJ1Ijoic2FoaWxjb2RlcjEiLCJhIjoiY2xiM21zN3plMDJtcDNvbzh3MHFtZGd3NyJ9.lPoY0IZhK8CSkF98_CwHbQ";
...
function AddComplaint() {
  ...
  //   form.append('email','abc@gmail.com');
  //   form.append('lon',pickup[0]);
  //   form.append('lat',pickup[1]);
  //   form.append('address',address);
  //   form.append('img',file);
  //   form.append('complaint',complaint);
  //   form.append('tags',false);
